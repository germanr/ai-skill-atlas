  ...
  return (
    <section style={{ paddingTop: 52, paddingBottom: 8 }}>
      ...
      <p style={{ fontSize: 11.5, color: C.ink3, lineHeight: 1.6, marginTop: 9 }}>
        Counts cover the full learning dataset. Sample counts may refer to people, sessions, or other observations, so they are not added together.
      </p>
    </section>
  );
}
    ...
    <div style={{ background: C.paper, minHeight: "100vh", animation: "fadeIn 0.25s" }}>
      ...
      <div className="wrap" style={{ maxWidth: 780, margin: "0 auto", padding: "44px 28px 90px" }}>
        ...
        <p style={{ ...body, marginTop: 26 }}>
          ...
          (plus a few quasi-experiments) across {nCountries} country or multi-country setting labels, with
        ...
        <p style={body}>
          ...
          Existing sample definitions are being reviewed. For example, the Kalam record currently
          reports 21 under its sample field. Its denominator or inclusion exception needs confirmation.
          No study has been removed as part of this labeling review.
        </p>
        ...
        <div style={{ marginTop: 16, border: `1px solid ${C.rule}`, borderRadius: 2, background: C.paperHi, padding: "16px 20px" }}>
          ...
          <div style={{ display: "grid", gap: 9 }}>
            {[
              ...
              ["estimate_analyzed_n / unit", "Analyzed sample for this estimate. May differ across outcomes from the same study."],
