...
PAPER_META = {
    ...
    'Hou et al. (2026)': dict(
        ...
        summary='An online three-arm RCT with 95 undergraduates testing whether a five-step prompting framework changes what students learn from a course-grounded (RAG) generative-AI assistant. Guided AI use raised unassisted post-test scores (d~0.86), mainly through open-ended reasoning items, while free-form AI use was no better than slide-only review.',
