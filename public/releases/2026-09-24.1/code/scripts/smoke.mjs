...
check(!math.some(e => e.paper_key === "chung_etal_2025"), "Math must not include Chung's coding-exam outcomes");
...
check(coding.some(e => e.paper_key === "chung_etal_2025"), "Coding must include Chung's coding-exam outcomes");
