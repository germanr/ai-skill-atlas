...
function AppInner() {
  ...
  const openPaper = (p) => {
    ...
    window.history.pushState({ inApp: true }, "", `${window.location.pathname}?paper=${p.paper_key}${window.location.hash}`);
  };
  const closePaper = () => {
  ...
  const filteredEstimates = useMemo(() => {
    ...
    return filterEstimates(estimates, { paperKeys, designMode, comparisonType, outcomeMode, activeDomains });
  }, [filteredPapers, estimates, designMode, comparisonType, outcomeMode, activeDomains]);
